module.exports = {
  name: 'Buscar palavra inclusa em um item da lista',
  ...
  subtitle(data) {
    ...
    return `Buscar palavra "${data.item}" inclusa em ${list[parseInt(data.list, 10)]}`;
  },
...
<div style="padding-top: 8px;">
  Buscar palavra inclusa em um item:<br>
...
Caso não encontre retornará sempre -1</p></div>`;
  ...
  async action(cache) {
    ...
    const result = list.findIndex((i) => i.includes(item));
